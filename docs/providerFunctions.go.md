...
```go
import "github.com/cdktn-io/cdktn-provider-cfncompat-go/cfncompat/providerfunctions"

providerfunctions.NewCfncompatProviderFunctions(providerLocalName *string) CfncompatProviderFunctions
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.Initializer.parameter.providerLocalName">providerLocalName</a></code> | <code>*string</code> | The local name of the provider in required_providers; |
...
```go
func Cidr(ipBlock *string, count *f64, cidrBits *f64) *[]*string
```
...
```go
func ConditionAnd(conditions *[]interface{}) IResolvable
```
...
```go
func ConditionContains(listOfStrings *[]*string, value *string) IResolvable
```
...
```go
func ConditionEachMemberEquals(listOfStrings *[]*string, value *string) IResolvable
```
...
```go
func ConditionEachMemberIn(stringsToCheck *[]*string, stringsToMatch *[]*string) IResolvable
```
...
```go
func ConditionEquals(value1 interface{}, value2 interface{}) IResolvable
```
...
```go
func ConditionIf(condition interface{}, valueIfTrue interface{}, valueIfFalse interface{}) IResolvable
```
...
```go
func ConditionNot(condition interface{}) IResolvable
```
...
```go
func ConditionOr(conditions *[]interface{}) IResolvable
```
...
```go
func FindInMap(mapping interface{}, topLevelKey *string, secondLevelKey *string, defaultValue *[]interface{}) IResolvable
```
...
```go
func LengthOf(value interface{}) *f64
```
...
```go
func Select(index *f64, objects interface{}) IResolvable
```
...
```go
func Split(delimiter *string, source *string) *[]*string
```
...
```go
func Sub(template *string, variables *map[string]*string) *string
```
