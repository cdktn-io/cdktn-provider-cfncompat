...
```python
from cdktn_provider_cfncompat import provider_functions

providerFunctions.CfncompatProviderFunctions(
...
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.Initializer.parameter.providerLocalName">provider_local_name</a></code> | <code>str</code> | The local name of the provider in required_providers; |

---

##### `provider_local_name`<sup>Required</sup> <a name="provider_local_name" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.Initializer.parameter.providerLocalName"></a>
...
| <code><a href="#@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionAnd">condition_and</a></code> | Returns `true` if all the specified `conditions` evaluate to `true`, or returns `false` if any one of the conditions evaluates to `false`. |
| <code><a href="#@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionContains">condition_contains</a></code> | Returns `true` if `value` matches at least one member of `list_of_strings`. |
| <code><a href="#@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionEachMemberEquals">condition_each_member_equals</a></code> | Returns `true` if every member of `list_of_strings` equals `value`, mirroring CloudFormation's rule-specific [`Fn::EachMemberEquals`](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/intrinsic-function-reference-rules.html#fn-eachmemberequals) intrinsic function. |
| <code><a href="#@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionEachMemberIn">condition_each_member_in</a></code> | Returns `true` if each member in `strings_to_check` is present in `strings_to_match`, and `false` otherwise. |
| <code><a href="#@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionEquals">condition_equals</a></code> | Compares if two values are equal. Returns `true` if the two values are equal, or `false` if they aren't. |
| <code><a href="#@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionIf">condition_if</a></code> | Returns `value_if_true` if `condition` evaluates to `true`, or `value_if_false` if `condition` evaluates to `false`. |
| <code><a href="#@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionNot">condition_not</a></code> | Returns `true` for a `condition` that evaluates to `false`, or `false` for a `condition` that evaluates to `true`. |
| <code><a href="#@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionOr">condition_or</a></code> | Returns `true` if any one of the specified `conditions` evaluates to `true`, or returns `false` if all the conditions evaluate to `false`. |
| <code><a href="#@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.findInMap">find_in_map</a></code> | Returns the value corresponding to `top_level_key` and `second_level_key` in the two-level `mapping`. |
...
| <code><a href="#@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.lengthOf">length_of</a></code> | Returns the number of elements within an array. |
...
def cidr(
  ...
  cidr_bits: typing.Union[int, float]
) -> typing.List[str]
```
...
###### `ip_block`<sup>Required</sup> <a name="ip_block" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.cidr.parameter.ipBlock"></a>
...
###### `cidr_bits`<sup>Required</sup> <a name="cidr_bits" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.cidr.parameter.cidrBits"></a>
...
##### `condition_and` <a name="condition_and" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionAnd"></a>

```python
def condition_and(
  conditions: typing.List[bool | IResolvable]
) -> IResolvable
```
...
- *Type:* typing.List[bool | cdktn.IResolvable]
...
##### `condition_contains` <a name="condition_contains" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionContains"></a>
...
###### `list_of_strings`<sup>Required</sup> <a name="list_of_strings" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionContains.parameter.listOfStrings"></a>
...
##### `condition_each_member_equals` <a name="condition_each_member_equals" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionEachMemberEquals"></a>
...
###### `list_of_strings`<sup>Required</sup> <a name="list_of_strings" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionEachMemberEquals.parameter.listOfStrings"></a>
...
##### `condition_each_member_in` <a name="condition_each_member_in" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionEachMemberIn"></a>

```python
def condition_each_member_in(
  strings_to_check: typing.List[str],
  strings_to_match: typing.List[str]
) -> IResolvable
```
...
###### `strings_to_check`<sup>Required</sup> <a name="strings_to_check" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionEachMemberIn.parameter.stringsToCheck"></a>
...
###### `strings_to_match`<sup>Required</sup> <a name="strings_to_match" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionEachMemberIn.parameter.stringsToMatch"></a>
...
##### `condition_equals` <a name="condition_equals" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionEquals"></a>
...
##### `condition_if` <a name="condition_if" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionIf"></a>

```python
def condition_if(
  condition: bool | IResolvable,
  value_if_true: typing.Any = None,
  value_if_false: typing.Any = None
) -> IResolvable
```
...
###### `value_if_true`<sup>Optional</sup> <a name="value_if_true" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionIf.parameter.valueIfTrue"></a>
...
###### `value_if_false`<sup>Optional</sup> <a name="value_if_false" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionIf.parameter.valueIfFalse"></a>
...
##### `condition_not` <a name="condition_not" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionNot"></a>
...
##### `condition_or` <a name="condition_or" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.conditionOr"></a>
...
##### `find_in_map` <a name="find_in_map" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.findInMap"></a>
...
def find_in_map(
  ...
  default_value: typing.List[typing.Any]
) -> IResolvable
```
...
###### `top_level_key`<sup>Required</sup> <a name="top_level_key" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.findInMap.parameter.topLevelKey"></a>
...
###### `second_level_key`<sup>Required</sup> <a name="second_level_key" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.findInMap.parameter.secondLevelKey"></a>
...
###### `default_value`<sup>Required</sup> <a name="default_value" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.findInMap.parameter.defaultValue"></a>
...
##### `length_of` <a name="length_of" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.lengthOf"></a>
...
##### `to_json_string` <a name="to_json_string" id="@cdktn/provider-cfncompat.providerFunctions.CfncompatProviderFunctions.toJsonString"></a>
