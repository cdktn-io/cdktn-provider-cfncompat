...
```typescript
import { providerFunctions } from '@cdktn/provider-cfncompat'

new providerFunctions.CfncompatProviderFunctions(providerLocalName: string)
```
...
```typescript
public conditionAnd(conditions: (boolean | IResolvable)[]): IResolvable
```
...
```typescript
public conditionContains(listOfStrings: string[], value: string): IResolvable
```
...
```typescript
public conditionEachMemberEquals(listOfStrings: string[], value: string): IResolvable
```
...
```typescript
public conditionEachMemberIn(stringsToCheck: string[], stringsToMatch: string[]): IResolvable
```
...
```typescript
public conditionEquals(value1: any, value2: any): IResolvable
```
...
```typescript
public conditionIf(condition: boolean | IResolvable, valueIfTrue?: any, valueIfFalse?: any): IResolvable
```
...
```typescript
public conditionNot(condition: boolean | IResolvable): IResolvable
```
...
```typescript
public conditionOr(conditions: (boolean | IResolvable)[]): IResolvable
```
...
```typescript
public findInMap(mapping: any, topLevelKey: string, secondLevelKey: string, defaultValue: any[]): IResolvable
```
...
```typescript
public select(index: number, objects: any): IResolvable
```
