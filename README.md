...
# CDKTN prebuilt bindings for cdktn-io/cfncompat provider version 0.3.0

This repo builds and publishes the [Terraform cfncompat provider](https://registry.terraform.io/providers/cdktn-io/cfncompat/0.3.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform cfncompat provider](https://registry.terraform.io/providers/cdktn-io/cfncompat/0.3.0)
